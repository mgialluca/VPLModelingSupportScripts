...
test_object = Generate_Atmosphere_Parameter_Sweep('Bzoom2', 
...
test_object.escape_samples_gridsweep['O'] = [0.001, 0.5] #[0.01, 0.1] #[0.01, 1]
test_object.escape_samples_gridsweep['O2'] = [0.001, 0.01] #[0.01, 0.1]
