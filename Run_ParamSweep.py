...
test_object = Generate_Atmosphere_Parameter_Sweep('Bco2wL3', 
...
test_object.outgass_species_MinMax_gridsweep['H2O'] = [34819000000.0, 9.77334769e11]#[34819000000.0, 9.77334769e11]
...
test_object.outgass_sample_resolution_gridsweep = [4, 8]
...
test_object.escape_samples_gridsweep['CO'] = [1e-3, 1e-6]
test_object.escape_samples_gridsweep['CO2'] = [0.01]
