...
test_object = Generate_Atmosphere_Parameter_Sweep('Ginit', 
                                  '/gscratch/vsm/gialluca/VPLModelingTools_Dev/UpdatedStarts/T1gInpR/PhotochemInputs/', 
                                restart_run= True, 
...
test_object.outgass_species_MinMax_gridsweep['H2O'] = [44586417.14082111, 8.75579486e11]
#test_object.outgass_species_MinMax_gridsweep['CO2'] = [89708.9258056, 4.64144598e10]
