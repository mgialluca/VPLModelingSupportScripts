...
def run_starting_points(case):
    ...
    if case == 'GbO2-CO2b01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O2-CO2_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'CO2', 'CO']

    elif case == 'GbO2-CO2b1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O2-CO2_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'CO2', 'CO']

    elif case == 'GbO25pH2Ob01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O2_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2']

    elif case == 'GbO25pH2Ob1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O2_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2']

    elif case == 'GbO210pH2Ob01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O210p_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2']

    elif case == 'GbO210pH2Ob1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O210p_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2']

    elif case == 'GbO240pH2Ob01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O240p_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2', 'H2']

    elif case == 'GbO240pH2Ob1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O240p_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2', 'H2']

    elif case == 'GbO250pH2Ob01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O250p_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2', 'H2']

    elif case == 'GbO250pH2Ob1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O250p_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2', 'H2']

    elif case == 'GbO260pH2Ob01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O260p_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2', 'H2']

    elif case == 'GbO260pH2Ob1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O260p_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'H2O2', 'H2']
...
inputs = ['GbO240pH2Ob01', 'GbO240pH2Ob1', 'GbO250pH2Ob01', 'GbO250pH2Ob1', 'GbO260pH2Ob01', 'GbO260pH2Ob1']#['b01', 'b1', 'b10']
