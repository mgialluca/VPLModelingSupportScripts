...
def run_starting_points(case):
    ...
    if case == 'GbCO2b01':
        ...
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/CO2_10bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'CO2', 'CO']

    elif case == 'GbH2Ob01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/H2O_01bar/'
        planet = 'GJ12b'
    ...
    elif case == 'Gbo2so2b01':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O2-SO2_01bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'SO2', 'SO3']
    
    elif case == 'Gbo2so2b1':
        initin = '/gscratch/vsm/gialluca/VPLModelingTools_Dev/GJ12b_Starts/O2-SO2_1bar/'
        planet = 'GJ12b'
        gas_names = ['O2', 'H2O', 'O3', 'SO2', 'SO3']
...
inputs = ['GbCO2b01', 'GbCO2b1', 'GbCO2b10']#['b01', 'b1', 'b10']
