...
test_object = Generate_Atmosphere_Parameter_Sweep('Czoom2', 
...
test_object.escape_samples_gridsweep['O'] = [0.001, 0.05]
test_object.escape_samples_gridsweep['O2'] = [0.001, 0.05]
