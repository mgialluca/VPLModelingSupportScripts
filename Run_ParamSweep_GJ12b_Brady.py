...
test_object = Generate_Atmosphere_Parameter_Sweep('GJ12bCO2', 
...
test_object.outgass_sample_resolution_gridsweep = [3, 3]
...
test_object.escape_samples_gridsweep['CO2'] = [0.001, 0.01]
