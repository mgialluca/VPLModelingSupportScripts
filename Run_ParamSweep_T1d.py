...
test_object = Generate_Atmosphere_Parameter_Sweep('Dco2wL2', 
...
test_object.outgass_species_MinMax_gridsweep['H2O'] = [28624000000.0, 5.77317886e11] #[28624000000.0, 5.77317886e11]
...
test_object.escape_samples_gridsweep['CO'] = [1e-6, 1e-7]
test_object.escape_samples_gridsweep['CO2'] = [0.01, 0.001]
