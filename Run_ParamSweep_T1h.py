...
test_object = Generate_Atmosphere_Parameter_Sweep('Hco2', 
                                  '/gscratch/vsm/gialluca/VPLModelingTools_Dev/UpdatedStarts/T1hStco2/PhotochemInputs/', 
                                restart_run= True, 
...
test_object.outgass_species_MinMax_gridsweep['H2O'] = [74210561.02002613, 5.36014581e11]
test_object.outgass_species_MinMax_gridsweep['CO2'] = [169730.85099039, 3.66594496e10]
